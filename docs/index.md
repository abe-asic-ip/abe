...
The [pkt-quantize](pkt_quantize.md) tool calculates bandwidth and packet rate metrics for packet-based interfaces where packets are quantized to bus beats.
